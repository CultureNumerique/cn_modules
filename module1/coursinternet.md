...
```Activité
::1.2.1 Quizz (Q1/2)::
[html]<p>De quand datent les premiers ordinateurs ?</p>
{
~<p>Au XVIIe siècle</p> 
...
::1.2.1 Quizz (Q2/2)::
[html]<p>Que dit la loi de Moore ?</p>
{ 
...
```activité 
::1.2.2 Quizz (Q1/2)::
[html]<p>Entre mon ordinateur et l'ordinateur de mon père qui
ont 12 ans d'écart, quelle est la différence de puissance à laquelle
on peut s'attendre ?</p>
{
...
####<p>2 ans \: x 2<br />4 ans \: x 4<br />6 ans \: x 8<br />8 ans \: x1 6<br />10 ans \: x 32 <br /><strong>12 ans \: x 64</strong></p>\n<p>En d'autres mots un traitement qui prenait <strong>30 min</strong> avec
l'ordinateur de mon père s'effectue en <strong>28 s</strong> sur le mien !</p> }


::1.2.2 Quizz (Q2/2)::
[html]<p>D'où vient le mot "bug" ?<br />Il est malheureusement
